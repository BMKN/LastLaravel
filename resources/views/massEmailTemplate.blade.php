...
@section('content')
    <div class="container text-center">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h1> LAST Course {{$data['date']}} {{$data['name']}} </h1>
                    <h5 class="card-title">Thank you for registering for the Day 1 (core modules) online course.</h5>
                    <p class="card-text">No 18. This is scheduled to be held on the {{$data['date']}}.</p>
                    <p class="card-text">Please read on for important course information.</p>
                    <p class="card-text">Please put these fixed dates in your diary: {{$data['date']}}.</p>
